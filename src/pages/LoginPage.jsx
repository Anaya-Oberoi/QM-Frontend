        ...
        <div className="auth-form-panel">
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            <div>
              ...
              <input className="field-input" type="email" id="login-email" placeholder="name@example.com"
            ...
            <div>
              ...
              <PasswordInput id="login-pass" value={password} onChange={e => setPassword(e.target.value)} autoComplete="current-password" />
